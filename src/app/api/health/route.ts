  ...
  try {
    ...
    return NextResponse.json({
      ...
      agentLoop: {
        ...
        watchdogLastHealthyAt: scheduler.watchdogLastHealthyAt,
        watchdogLastAlertAt: scheduler.watchdogLastAlertAt,
        watchdogLastRecoveryAt: scheduler.watchdogLastRecoveryAt,
