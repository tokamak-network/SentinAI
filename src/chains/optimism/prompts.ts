/**
 * Optimism Chain - AI Prompt Fragments
 * Extracted verbatim from existing engine modules
 */
...
const ANOMALY_ANALYZER_CONTEXT = `## Optimism Component Relationships:
...
const NLOPS_SYSTEM_CONTEXT = `You are a helpful assistant for SentinAI, an Optimism L2 node monitoring system.`;

// ============================================================
// Export
// ============================================================

export const OPTIMISM_AI_PROMPTS: ChainAIPrompts = {
