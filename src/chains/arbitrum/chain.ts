...
const DEFAULT_CHAIN_ID = 412346;
const DEFAULT_CHAIN_NAME = 'Arbitrum Orbit Local L2';
const DEFAULT_CHAIN_NETWORK = 'arbitrum-orbit-local';
const DEFAULT_RPC_URL = 'http://localhost:8547';
...
export const arbitrumOrbitChain = defineChain({
  ...
  blockExplorers: {
    default: { name: 'Explorer', url: process.env.L2_EXPLORER_URL || 'http://localhost:4000' },
  },
