...
} from '@/core/playbook-system/playbook-validation';
import { generatePlaybookFromPattern } from '@/core/playbook-system/playbook-generator';
import type { IncidentPattern } from '@/core/playbook-system/types';
...
describe('playbook validation', () => {
  ...
  it('enforces review status transition rules', () => {
    ...
    const denied = validateStatusTransition({ from: 'trusted', to: 'draft' });
