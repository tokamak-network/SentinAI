...
function AdminLoginContent() {
  ...
  async function handleConnect() {
    ...
    try {
      ...
      const nonceRes = await fetch(`/api/admin/auth/nonce?address=${userAddress}`);
      if (!nonceRes.ok) {
      ...
      const message = [
        'SentinAI Marketplace Admin wants you to sign in with your Ethereum account:',
        userAddress,
        '',
        'Sign in to SentinAI Marketplace Admin Panel',
        '',
                ...
                {state === 'idle' && (
                  <>
                    ...
                    <p style={{ fontSize: '11px', color: '#888', marginTop: '8px' }}>
                      Only the authorized marketplace operator account can access this page.
                    </p>
                  </>
                )}
